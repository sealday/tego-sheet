...
describe('template render pipeline', () => {
  ...
  it('prints parallel active tables with the same deterministic left-to-right row projection', async () => {
    const tableSource = {
      ...source,
      workbook: {
        ...source.workbook,
    ...
    expect(texts).toEqual(['Left', 'Amount', 'West', '6', 'Right', 'Amount', 'North', '3']);
  });
