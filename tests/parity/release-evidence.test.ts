...
import { verifyEvidenceArtifacts } from '../../scripts/verify-parity-manifest.ts';

const serializedPaths = process.env.TEGO_PARITY_EVIDENCE_PATHS;
const releaseTest = serializedPaths === undefined ? test.skip : test;
