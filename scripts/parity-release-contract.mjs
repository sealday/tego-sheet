...
export const browserProjects = Object.freeze([
  {
    ...
    use: { browserName: 'chromium', viewport: { height: 720, width: 1280 } },
  },
  {
    name: 'firefox-desktop',
    use: { browserName: 'firefox', viewport: { height: 720, width: 1280 } },
  },
  {
    name: 'webkit-desktop',
    use: { browserName: 'webkit', viewport: { height: 720, width: 1280 } },
  },
  {
    name: 'chromium-touch',
    use: { browserName: 'chromium', hasTouch: true, viewport: { height: 844, width: 390 } },
  },
  {
    name: 'firefox-touch',
    use: { browserName: 'firefox', hasTouch: true, viewport: { height: 844, width: 390 } },
  },
  {
    name: 'webkit-touch',
    use: { browserName: 'webkit', hasTouch: true, viewport: { height: 844, width: 390 } },
  },
]);
...
export const visualProjects = Object.freeze([
  {
    name: 'desktop-dpr1',
    use: { browserName: 'chromium', deviceScaleFactor: 1, viewport: { height: 720, width: 1280 } },
  },
  {
    name: 'desktop-dpr2',
    use: { browserName: 'chromium', deviceScaleFactor: 2, viewport: { height: 720, width: 1280 } },
  },
  {
    name: 'touch-dpr1',
    use: {
