...
export interface CommandCommit<Result = void, Command extends WorkbookCommand = WorkbookCommand> {
...
export type CommandOutcome<Result = void, Command extends WorkbookCommand = WorkbookCommand> =
