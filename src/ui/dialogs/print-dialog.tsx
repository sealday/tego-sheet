...
export function PrintDialog(props: {
  ...
  return (
    ...
    >
      ...
      <label>
        {props.t('print.orientation', 'Orientation')}
        <select
          value={orientation}
          onChange={(event) => setOrientation(event.target.value as PaperOrientation)}
        >
      ...
      <button type="button" onClick={() => props.onPrint({ orientation, paper })}>
        {props.t('print.print', 'Print')}
      </button>
